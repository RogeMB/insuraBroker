...
INSERT INTO CLIENTES (id_cliente, nombre, apellidos, dni, fecha_nacimiento, telefono, email, genero, fecha_alta, es_premium)
    VALUES (NEXTVAL('hibernate_sequence'), 'Charisse', 'Cicchitello Romani', '11111020V', '1981-02-08', '644274264' , 'cicchitello0@gmail.com', 'Mujer', '2022-01-22', 'false');
INSERT INTO CLIENTES (id_cliente, nombre, apellidos, dni, fecha_nacimiento, telefono, email, genero, fecha_alta, es_premium)
    VALUES (NEXTVAL('hibernate_sequence'), 'Marsha', 'Roswarne Gómez', '14314326M', '1988-07-07', '642928815' , 'mroswarne1@gmail.com', 'Mujer', '2021-08-14', 'false');
INSERT INTO CLIENTES (id_cliente, nombre, apellidos, dni, fecha_nacimiento, telefono, email, genero, fecha_alta, es_premium)
    VALUES (NEXTVAL('hibernate_sequence'), 'Lindie', 'Forlonge Martín', '13023813N', '1982-04-18', '605435540' , 'lforlonge2@gmail.com', 'Mujer', '2020-04-17', 'false');
INSERT INTO CLIENTES (id_cliente, nombre, apellidos, dni, fecha_nacimiento, telefono, email, genero, fecha_alta, es_premium)
    VALUES (NEXTVAL('hibernate_sequence'), 'Nicoli', 'Warland Cabezas', '20221137H', '1956-05-28', '603460515' , 'nwarland3@gmail.com', 'Mujer', '2020-04-23', 'false');
INSERT INTO CLIENTES (id_cliente, nombre, apellidos, dni, fecha_nacimiento, telefono, email, genero, fecha_alta, es_premium)
